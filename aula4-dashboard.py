...
#rodar o projeto: streamlit run aula4-dashboard.py
...
st.markdown("Explore os dados salariais na área de dados nos últimos anos. Utiliza os filtros à esquerda para refinar sua análise.")
...
with col_graf1:
    if not df_filtrado.empty:
        ...
        grafico_cargos = px.bar(
            ...
            labels={'usd': 'Média salarial anula (USD)', 'cargo': ''}
        )
...
with col_graf3:
    if not df_filtrado.empty:
        ...
        st.warning("Nenhum dados para exibir no gráfico dos tipos de trabalho.")
